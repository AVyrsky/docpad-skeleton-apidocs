const config = {
  ...
  docuUrl: process.env.docuURL || 'https://AVyrsky.github.io',
  ...
  registry: {
    ...
    path: process.env.REGISTRY_PATH || 'https://github.com/AVyrsky/apidoc-workshop-docu_registry.git',
  ...
  generationResult: {
    srcLocation: 'https://github.com/AVyrsky/AVyrsky.github.io.git',
    branch: process.env.docuBranch || 'master',
